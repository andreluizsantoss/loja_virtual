String getErrorString(String code) {
  switch (code) {
    ...
    case 'expired-action-code':
      return 'O código da ação ou link expirou.';
    case 'invalid-action-code':
      return 'O código da ação é inválido. Isso pode acontecer se o código estiver malformado ou já tiver sido usado.';
    case 'user-disabled':
      return 'O usuário correspondente a credencial fornecida foi desativado.';
    case 'user-not-found':
      return 'O usuário não correponde a nenhuma credencial.';
    case 'weak-password':
    ...
    case 'operation-not-allowed':
      return 'O tipo de conta correspondente a esta credencial, ainda não encontra-se ativada.';
    ...
    case 'wrong-password':
      return 'Senha ou E-mail incorreto.';
